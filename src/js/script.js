...
function addListItem() {
  productsList.innerHTML += (`
    <li class="products-list_items products-carousel_items" title="O combo contém produtos que entregam fios saudáveis e livres de pontas duplas por meio de ativos poderosos.">
